...
import db.DBManager;
import dto.Member;
import reservation.CreateSmallCan;
import reservation.EmptyCalendar;
import reservation.ResCalendar;
...
public class ReservationPanel extends JPanel implements ActionListener{
	...
	public ReservationPanel(Member dto) {
		this.dto=dto;
		p_north = new JPanel();
	...
	public void itemStateChanged(ItemEvent e) {
		if(choice.getSelectedIndex() != 0) {
			...
			try {
				...
				String str = obj.toString();
				//스트링에서 숫자만 추출하기
				ReservationPanel.this.roomNum=Integer.parseInt(str.replaceAll("[^0-9]",""));
				p_center.removeAll();
				attachPanel();
